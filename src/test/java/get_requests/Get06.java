...
*/
    ...
    public void get06() {
        //set the url
        spec.pathParams("first","booking","second",1224);
        ...
        //2.yol Json Path
        JsonPath jsonPath=response.jsonPath(); //response jsenpath objesine çevirdik
        ...
        //Soft assertion için testNg ye ihtiyacımız var
